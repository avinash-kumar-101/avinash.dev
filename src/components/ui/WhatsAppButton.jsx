...
const WhatsAppButton = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("navmenu:open", show);
    window.addEventListener("navmenu:close", hide);
    return () => {
      window.removeEventListener("navmenu:open", show);
      window.removeEventListener("navmenu:close", hide);
    };
  }, []);
